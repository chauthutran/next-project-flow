            ...
            <div className="space-y-4">
                <div className="bg-blue-navy text-slate-50 rounded-lg px-5 py-3 space-y-4">
                    <div className="text-lg border-b border-light-sky-blue flex">
                        ...
                        <div className="flex-1 flex justify-end space-x-2 mb-1">
                            <div className="text-slate-600 bg-gold rounded-full p-2 cursor-pointer" onClick={() => setMainPage(Constant.PAGE_USER_TIMELINE)} ><FaTimeline /></div>
