...
import { addMilestone, deleteMilestone, fetchMilestonesByProjectId, updateMilestone } from "@/redux/milestones/milestonesThunk";
...
export function useMilestones() {
    ...
    const { milestones, selectedMilestone, loading, error } = useSelector( (state: RootState) => state.milestones );
